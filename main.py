...
bot = telebot.TeleBot("2135106865:AAEFLsBo8mM8T3_q8lcRxRwiO5aMTp7ApUQ")


class DataBase:
	def __init__(self):
		cluster = MongoClient("mongodb+srv://user:51423@cluster0.3bn17.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")
